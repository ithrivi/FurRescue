...
<head>
    ...
    <link rel="stylesheet" href="Boarding.css" type="text/css">
</head>
...
<?php
  ...
  ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white" style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol;">
        ...
        <img src="brd.jpg" height="700px" width="100%">
        <h1 style="font-family: 'Garamond'; text-align: center; font-size: 70px;color:#aaa">DOG BOARDING</h1><br>
        <h3 style="font-family: Arial, Helvetica, sans-serif;font-size: 24px; color: #aaa; text-align: justify; font-style: italic; font-family: cursive; margin-left: 5%; margin-right: 5%; ">Upgrade to Fur Rescue and avail our dog boarding services. 
            We know exactly how heart-breaking it is to leave your dog when going on holiday. Or even just heading to work when you can’t find a sitter. So to save you the grief, we’ve found you places and people who have opened up their homes just for your furry friends. So ditch the kennels and cages in favour of off-leash playtime and oodles of warmth from these boarding and loving temporary parents.
            Your pets might not be accustomed to being left alone or may refuse to eat or drink in the absence of your care. This can cause stress and anxiety for them, as well as a lot of strain on you.
            <br><br>Fur Rescue understand the worries of pet parents and is here to help you find the best Dog Boarding near you. If you are looking for a personalized, off leash, homely experience for your pets where you can leave them without having to worry about any of their needs, we got you covered. We offer the safest pawspace for your pet.
            We offer you a wide range of the best dog boarding near your location with verified Pet hosts who will provide the homely experience for your pet and make sure they are happy and agile even while you are away.
        </h3>
    <div class="formbold-main-wrapper">
        <div class="formbold-form-wrapper" style="border-color: #07074d; border-radius: 50 px;border-style: ridge;background-color: white; ">
                ...
                <div class="flex flex-wrap formbold--mx-3">
                  <div class="w-full sm:w-half formbold-px-3">
                    <div class="formbold-mb-5 w-full">
                      <label for="date" class="formbold-form-label"> From Date </label>
                      <input type="date" required name="fdate" id="demo1" class="formbold-form-input"/>
                    </div>
                  </div>
                  <div class="w-full sm:w-half formbold-px-3">
                    <div class="formbold-mb-5">
                      <label for="time" class="formbold-form-label"> Time </label>
                      <input type="time" required name="ftime" id="ftime" class="formbold-form-input"/>
                    </div>
                  </div>
                </div>
                <div class="flex flex-wrap formbold--mx-3">
                    <div class="w-full sm:w-half formbold-px-3">
                      <div class="formbold-mb-5 w-full">
                        <label for="date" class="formbold-form-label"> To Date </label>
                        <input type="date" required name="tdate" id="demo2" class="formbold-form-input"/>
                      </div>
                    </div>
                    <div class="w-full sm:w-half formbold-px-3">
                      <div class="formbold-mb-5">
                        <label for="time" class="formbold-form-label"> Time </label>
                        <input type="time" required name="ttime" id="ttime" class="formbold-form-input"/>
                      </div>
                    </div>
                  </div>
                <div class="formbold-mb-5 formbold-pt-3">
                    ...
                    <div class="flex flex-wrap formbold--mx-3">
                     ...
                     <div class="w-full sm:w-half formbold-px-3">
                      ...
                      <div class="w-full sm:w-half formbold-px-3"></div>  
                        ...
                        <div class="formbold-mb-5">
                          <label for="" class="" style="margin-left: 40px;" >Health Concerns</label>
                          <input type="text" name="health" id="health" style="margin-left: 40px;" placeholder="Give the Health Concerns(if any)" class="health"/>
                        </div>
                        <div class="formbold-mb-5">
                            <label for="" class="" style="margin-left: 40px;">Food provided*</label><br>
                            <input type="text" class="food" name="food" id="food" required  placeholder="example: Royal Canine"><br>
                        </div>
                        <div class="formbold-mb-5">
                          <div class="stylenew">
                            <input type="checkbox" required name="details" id="details" value="Reason1"  style=" height: 12px; width: 30px; margin-left: 20px;">Details of the available boardings will be sent to your email and phone number.
                        </div>
                      </div>
                </div>
              </div>
...
if(!empty($name)){
    ...
    if(mysqli_connect_error()){
        ...
        $SELECT = "SELECT ID From board Where ID=? Limit 1";
        $INSERT = "INSERT Into board (name, phone, email, fdate, ftime, tdate, ttime, area, city, state, postcode, dogname, age, breed, health, food, ID) values( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if($rnum==0){
            ...
            $stmt->bind_param("sissssssssisisssi",$name, $phone, $email, $fdate, $ftime,  $tdate, $ttime, $area, $city, $state, $postcode, $dogname, $age, $breed, $health, $food, $id);
            $stmt->execute();
